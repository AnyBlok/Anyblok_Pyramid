...
def define_auth_option(group):
    ...
    group.add_argument(
        ...
        default=os.environ.get(
            "ANYBLOK_PYRAMID_AUTHTKT_COOKIE_NAME", "auth_tkt"
        ),
    ...
    group.add_argument(
        ...
        default=os.environ.get(
            "ANYBLOK_PYRAMID_REMOTEUSER_ENVIRON_KEY", "REMOTE_USER"
        ),
    ...
    group.add_argument(
        ...
        help=("he OIDC Provider urls (ie: https://gitlab.com)"),
    )
    group.add_argument(
...
def define_wsgi_debug_option(group):
    group.add_argument(
        "--pyramid-reload-all",
        dest="pyramid.reload_all",
        help="Turns on all reload* settings.",
        action="store_true",
    )
    group.add_argument(
        "--pyramid-reload-templates",
    ...
    group.add_argument(
        "--pyramid-debug-notfound",
        dest="pyramid.debug_notfound",
        help="Print view-related NotFound debug messages " "to stderr",
        action="store_true",
    )
    group.add_argument(
        "--pyramid-debug-routematch",
